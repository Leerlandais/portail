                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        ?>
                            ...
                            ?>
                        <td><a href="?update&dir=down&place=<?=$port["placement"]?>"><img src="images/arrow-up.svg" alt="up arrow"></a></td>
                        <?php } ?>
                        <?php
                            if ($port["placement"] === 0) {
                        ?>
                            ...
                            ?>
                        <td><a href="?update&dir=up&place=<?=$port["placement"]?>"><img src="images/arrow-down.svg" alt="down arrow"></a></td>                            
                        <?php } ?>
                        <td><?=$port["title"]?></td>
