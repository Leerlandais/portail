<form method="POST" id="updateLogForm" class="mt-5 w-25">
  <div class="mb-4">
    ...
    <input type="text" class="form-control" id="title" name="titleUpdate" value="<?=$oneLog["date"]?>">
  </div>
  <div class="mb-4">
    <label for="desc" class="form-label text-info">Log</label>
    <input type="text" class="form-control" id="desc" name="descUpdate" value="<?=$oneLog["log"]?>">
  </div>
